...
\begin{table}[H]
	...
	\begin{tabular}{|L{3cm} || C{2cm} | C{3cm} | C{3cm} | C{4cm}|}
		...
		A                             & \( 0.333 \)                 & \(\begin{pmatrix}2.89\\ -0.984 \end{pmatrix}\) & \(\begin{pmatrix}2.69\\ 0.866\end{pmatrix}\) & \(\begin{pmatrix}2.44 & -1.13 \\-1.13 & 0.614\\\end{pmatrix}\) \\\hline
...
\begin{table}[H]
	...
	\begin{tabular}{|L{3cm} || C{2cm} | C{3cm} |}
		...
		A                             & \(\begin{pmatrix}-593\\ -1029 \end{pmatrix}\) & -98.6                   \\\hline
