...
Given this resulting variational distribution, the expectation in  equation~\refeq{eq_llh} can be computed and the parameters \(\alpha\) and \(\beta\) can be estimated through the classical corresponding M-step:
\begin{equation*}
